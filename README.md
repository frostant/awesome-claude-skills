...
- [Karpathy Guidelines](https://github.com/swarmclawai/andrej-karpathy-skills) - Installs Karpathy-inspired coding-agent guidelines across Claude Code, Codex, Cursor, Gemini, OpenCode, OpenClaw, AGENTS.md, and other agent surfaces.
